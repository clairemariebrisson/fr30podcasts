import P2Nav from "@/components/p2/P2Nav";
import P2Studio from "@/components/p2/P2Studio";
      ...
      <main id="top" className="flex-1">
        <SectionsProvider defaultOpen="objectif">
          ...
          <div className="mx-auto max-w-5xl px-5 py-8">
            {/* Objectif */}
            <CollapsibleSection id="objectif" num={1} title="Objectif du Podcast 2">
              <Gloss
                en="In Podcast 2 you become a content creator: you make a fake mini-ad for a terroir product from the French-speaking world — think Reels, TikTok, or a tourism video. You tell the story of a place and its product using the whole Unit 2 toolkit."
            ...
            <CollapsibleSection
              id="studio"
              num={2}
              title="Studio — bâtissez votre pub"
            >
              <Gloss
                en="Six guided steps following the PACE model: watch a model ad, notice the structures, co-build your ad from a product you choose, check it, move from script to camera — then film and upload to Canvas."
                className="mb-8 max-w-3xl text-foreground/85"
              >
                Six étapes guidées, selon le modèle PACE : regardez une pub-modèle,
                repérez les structures, co-construisez votre pub à partir d'un
                produit que vous choisissez, vérifiez-la, passez du script à la
                caméra — puis filmez et déposez sur Canvas.
              </Gloss>
              <P2Studio />
            </CollapsibleSection>
            ...
            <CollapsibleSection
              id="evaluation"
              num={4}
              title="Grille d'évaluation du Podcast 2"
            >
