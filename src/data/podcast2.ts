...
export const grilleCriteres: Critere[] = [
  {
    critere: "Organisation & genre",
    axe: "structure de la pub & accroche",
    niveaux: [
      "Pub limpide et créative ; accroche qui capte d'emblée ; histoire claire et slogan qui marque ; le format (Reels / TikTok / tourisme) est parfaitement maîtrisé.",
      "Structure logique ; accroche et slogan présents ; le format est respecté ; quelques flottements de rythme.",
      "Organisation faible ; accroche ou slogan peu marqués ; le format publicitaire est peu lisible.",
      "Peu de structure ; ni accroche ni slogan nets ; ne ressemble pas à une pub.",
    ],
  },
  {
    critere: "Présentation à la caméra",
    axe: "énergie, débit, registre",
    niveaux: [
      "Présence à la caméra vivante et convaincante ; énergie « qui vend » ; débit fluide ; ton et registre parfaitement choisis.",
      "Bonne présence ; énergie présente ; débit assez fluide ; registre adapté.",
      "Présence hésitante ; énergie faible ; débit haché ; registre parfois mal choisi.",
      "Lecture sans énergie ; débit très haché ; registre inadapté.",
    ],
  },
  {
    critere: "Grammaire & structures",
    axe: "structures-cibles de l'Unité 2",
    niveaux: [
      "Cibles employées avec aisance et justesse — imparfait / passé composé / plus-que-parfait (l'aspect), conditionnel de la projection, adjectifs mélioratifs, connecteurs, mise en relief ; au service du récit.",
  ...
  },
  {
    ...
    axe: "lexique du terroir",
    niveaux: [
      "Lexique du terroir riche, précis et nuancé ; vocabulaire publicitaire bien employé.",
  ...
  },
  {
    ...
    axe: "authenticité du terroir, créativité, ODD",
    niveaux: [
      "Très créatif et personnalisé ; terroir francophone authentique et bien documenté ; lien lieu–climat–goût convaincant ; compréhension du genre au-delà des attentes.",
      "Créatif et personnalisé ; terroir crédible ; bon lien au lieu ; bonne compréhension du genre.",
      "Assez créatif ; terroir peu développé ; lien au lieu limité.",
      "Peu de créativité ; terroir vague ou inventé ; faible compréhension du genre.",
    ],
  },
];
