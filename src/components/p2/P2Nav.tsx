...
// Barre de navigation du Podcast 2. Identique à celle des autres podcasts mais
// sans lien vers un autre épisode : les étudiant·e·s ne voient que celui-ci.
export default function P2Nav() {
